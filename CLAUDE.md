...
au cas par cas (ex. `marked` + `dompurify` prévus pour l'éditeur Markdown). Toute
logique (parsing, diff, hash, lint, base64…) est **codée from scratch**, pure et testée.
