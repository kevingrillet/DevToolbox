...
/** Présentation « bloc » : état vide ou repli (ex. diff trop volumineux). */
export const Block: Story = {
  args: {
    block: true,
    children: 'Les textes sont trop volumineux pour une comparaison à cette granularité.',
  },
};
  ...
  render: () => (
    <div className="flex flex-col gap-2">
      ...
      <Callout tone="warning" badge="Précision">
        Certains nombres dépassent la précision des entiers JavaScript.
      </Callout>
      <Callout tone="danger" badge="Erreur">
        JSON invalide — ligne 1, colonne 8.
      </Callout>
    </div>
  ),
};
